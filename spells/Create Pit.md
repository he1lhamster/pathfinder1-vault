...
material_components: "{miniature shovel costing 10 gp}"
...
spell_resistance: "no"
short_text: "Creates an extradimensional pit."
text: |
...
spiritualist: ""
medium: ""
rated_name: <font style='color:blue'>Create Pit</font>
---

# <font style='color:blue'>Create Pit</font> 
**School:** conjuration (creation) 
_arcanist_ 2, _wizard_ 2, _sorcerer_ 2, _summoner_ 2, _unsummoner_ 2, 
#### Casting
**Casting Time:** 1 standard action
 **Components:** V, S, F (miniature shovel costing 10 gp) {miniature shovel costing 10 gp}
 #### Effects
**Range:** medium (100 ft. + 10 ft./level)
**Duration:** 1 round + 1 round/level
**Effect:** 10-ft.-by-10-ft. hole, 10 ft. deep/2 levels
...
You create a 10-foot-by-10-foot extradimensional hole with a depth of 10 feet per two caster levels (maximum 30 feet).
  ...
  Creatures subjected to an effect intended to push them into the pit (such as bull rush) do not get a saving throw to avoid falling in if they are affected by the pushing effect.
  Creatures who fall into the pit take falling damage as normal.
  The pit's coarse stone walls have a _[[universal monster rules/Climb|Climb]]_ DC of 25. When the duration of the spell ends, creatures within the hole rise up with the bottom of the pit until they are standing on the surface over the course of a single round.

 #### Other
**Source:** APG
**Rating:** 4
**Potion:** Yes
**Domain:** Caves (2); **Bloodline:** Kobold Sorcerer (5), Kobold (5); 