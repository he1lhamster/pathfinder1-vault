...
material_components: "{powdered corn and a twisted loop of parchment}"
range: "touch"
area: ""
effect: ""
...
saving_throw: "none"
spell_resistance: "no"
short_text: "As many as eight creatures hide in extradimensional space."
text: |
...
spiritualist: ""
medium: "2"
rated_name: <font style='color:blue'>Rope Trick</font>
---

# <font style='color:blue'>Rope Trick</font> 
**School:** transmutation 
_arcanist_ 2, _wizard_ 2, _sorcerer_ 2, _psychic_ 2, _occultist_ 2, _medium_ 2, 
#### Casting
**Casting Time:** 1 standard action
 **Components:** V, S, M (powdered corn and a twisted loop of parchment) {powdered corn and a twisted loop of parchment}
 #### Effects
**Targets:** one touched piece of rope from 5 ft. to 30 ft. long
**Range:** touch
**Duration:** 1 hour/level (D)
...
When this spell is cast upon a piece of rope from 5 to 30 feet long, one end of the rope rises into the air until the whole rope hangs perpendicular to the ground, as if affixed at the upper end.
  The upper end is, in fact, fastened to an extradimensional space that is outside the usual multiverse of extradimensional spaces.
  Creatures in the extradimensional space are hidden, beyond the reach of spells (including divinations), unless those spells work across planes. The space holds as many as eight creatures (of any size). The rope cannot be removed or hidden. The rope can support up to 16,000 pounds. A weight greater than that can _[[universal monster rules/Pull|pull]]_ the rope free.
  Spells cannot be cast across the extradimensional interface, nor can area effects cross it. Those in the extradimensional space can see out of it as if a 3-foot-by-5-foot window were centered on the rope. The window is _[[conditions/Invisible|invisible]]_, and even creatures that can see the window can't see through it. Anything inside the extradimensional space drops out when the spell ends. The rope can be climbed by only one person at a time. The rope _[[feats/Trick Spell|trick spell]]_ enables climbers to reach a normal place if they do not _[[universal monster rules/Climb|climb]]_ all the way to the extradimensional space.
