---
cssclass: [monsters]
title1: Ossumental, Ossumental (Fire)
title2: Ossumental (Fire)
CR: 12
sources:
...
attacks:
  ...
  - - text: 4 slams +21 (1d8+10/19-20)
      ...
      - 21
  special:
  - breath weapon (40-ft. cone, 6d6 bludgeoning and fire, Reflex DC 18 half, usable
    every 1d4 rounds)
  - discorporate
space: 10
reach: 10
...
ecology:
  ...
  treasure_type: none
special_abilities:
  Discorporate (Su): Formed by hundreds of humanoid bones, an ossumental can drop
    its form into a scattered pile of bones, allowing it to take 20 on Stealth checks
    to avoid being noticed for what it is. In addition, when an ossumental uses its
    breath weapon, it can, as a free action, transport itself to any unoccupied area
    affected by the breath weapon.
  Firesight (Ex): |-
...
# Ossumental, Ossumental (Fire)

**Source** Pathfinder #83: The Slave Trenches of Hakotep pg. 88
**XP** 19,200

NE Large undead (fire)
**Init** +3; **Senses** _[[spells/Darkvision|darkvision]]_ 60 ft., _[[feats/Firesight|firesight]]_; Perception +26
...
**DR** 10/magic; **Immune** fire, _[[universal monster rules/Undead Traits|undead traits]]_
...
**Special Attacks** _[[universal monster rules/Breath Weapon|breath weapon]]_ (40-ft. cone, 6d6 bludgeoning and fire, Reflex DC 18 half, usable every 1d4 rounds), discorporate
...
**Skills** _[[universal monster rules/Climb|Climb]]_ +14, Intimidate +16, Knowledge (planes) +16, Perception +26, Sense Motive +4, Stealth +10
...
**_Firesight_ (Ex)** An ossumental can see through fire and smoke as if they were transparent, ignoring any cover or concealment bonuses from fire and smoke, up to its normal range of _[[spells/Vision|vision]]_.
