---
cssclass: [monsters]
title1: Tavern (Drunkard)
title2: Tavern (Drunkard)
CR: 1
sources:
...
gear:
  ...
  - dagger
  - gallon jug of ale
npc_boon: A drunkard can be persuaded to make a loud, obnoxious disturbance as a distraction,
  imposing a -2 penalty on opposed Perception checks (as against Stealth or Sleight
  of Hand) for up to 1 minute for any NPCs who can see and hear him.
desc_long: |-
...
**Source** GameMastery Guide pg. 303
**XP** 400
...
##### Offense
**Speed** 30 ft.
**Melee** _[[items/Weapon/Club|club]]_ +3 (1d6+1) or _[[items/Weapon/Dagger|dagger]]_ +3 (1d4+1/19–20)
**Ranged** _club_ +2 (1d6+1) or _dagger_ +2 (1d4+1/19–20)
...
**Skills** _[[universal monster rules/Climb|Climb]]_ +5, Handle Animal +4, Intimidate +5, Profession (choose one) +3, Ride +4, Swim +5
**Languages** Common
**Gear** _[[items/Armor/Leather armor|leather armor]]_, _club_, _dagger_, gallon _[[items/Mundane/Jug|jug]]_ of ale

**Boon** A drunkard can be persuaded to make a loud, obnoxious disturbance as a _[[universal monster rules/Distraction|distraction]]_, imposing a –2 penalty on opposed Perception checks (as against Stealth or Sleight of Hand) for up to 1 minute for any NPCs who can see and hear him.
